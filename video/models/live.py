...
def live_video_post_save_receiver(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        new_distribution = cloudfront.create_distribution(cf_settings, instance.organization, instance.channel)
    ...
    elif instance._old_geolocation_type != instance.geolocation_type or \
            instance._old_geolocation_countries != instance.geolocation_countries:
        cloudfront.update_distribution_geoblocking(instance.cf_id, instance.geolocation_type,
    ...
    # Executed only if channel is updated
        ...
        cloudfront.tag_distribution(instance.organization, instance.cf_id, [('vh:channel-id', str(instance.channel.id))])
