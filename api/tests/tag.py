...
from test_utils import create_organizations, create_user, create_superuser, create_tags, create_key
...
class TagTests(APITestCase):
    ...
    def setUp(self):
        self.tag1, self.tag2, self.tag3 = create_tags('Funny tag', self.org1, 3)
        self.tag4, self.tag5, self.tag6 = create_tags('Funny tag', self.org2, 3)
